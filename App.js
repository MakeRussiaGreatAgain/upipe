...
const keys = require('./src/api.json');
const apiKey = keys.youtube;
const maxRes = 5; //Conserving the number of requests sent to the API Can be modified at development
...
class App extends Component {
  ...
  componentDidMount(){
    fetch(`https://www.googleapis.com/youtube/v3/search?part=snippet&q=Music&type=video&key=${apiKey}&maxResults=${maxRes}`)
    .then(res => res.json())
    .then(res => {
      const videoId = [];
